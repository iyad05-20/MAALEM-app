    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <img src="/icons/icon-192x192.png" alt="Vork Logo" className="w-9 h-9 rounded-xl shadow-lg" />
          <span className="text-xl font-bold text-[#0B1D2D] tracking-tight">Vork</span>
        </div>
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-bold">
          <a
            href="#services"
            className="text-blue-electric hover:opacity-80 transition-all duration-200"
          >
            {t.services}
          </a>
          <a
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="lang-dropdown" ref={langRef}>
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 rounded-xl border border-blue-electric/20 bg-white/60 backdrop-blur-sm hover:border-blue-electric/40 transition-all duration-200 text-sm font-medium text-blue-electric"
            ...
            >
              ...
              <ChevronDown
                size={14}
                className={`text-blue-electric/60 transition-transform duration-200 ${langOpen ? 'rotate-180' : ''}`}
              />
            </button>
          ...
          {/* Mobile menu toggle */}
          <button
            className="md:hidden p-2 text-blue-electric transition-colors"
      ...
      {/* Mobile Menu */}
      {mobileOpen && (
        <div className="md:hidden glass-nav border-t border-blue-electric/10 px-6 py-4 flex flex-col gap-4 animate-fade-in-card">
          <a
            href="#services"
            className="text-blue-electric hover:opacity-80 font-bold text-sm"
